package binarymash.cloud.shopper.kafka.consumer.config;

import binarymash.cloud.shopper.kafka.config.data.KafkaConfigData;
import binarymash.cloud.shopper.kafka.config.data.KafkaConsumerConfigData;
