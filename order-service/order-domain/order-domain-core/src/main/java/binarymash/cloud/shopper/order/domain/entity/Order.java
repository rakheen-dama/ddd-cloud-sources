...
import binarymash.cloud.shopper.domain.valueobject.*;
import binarymash.cloud.shopper.order.domain.exception.OrderDomainException;
import binarymash.cloud.shopper.order.domain.valueobject.OrderItemId;
import binarymash.cloud.shopper.order.domain.valueobject.StreetAddress;
import binarymash.cloud.shopper.order.domain.valueobject.TrackingId;
...
public class Order extends AggregateRoot<OrderId> {
    ...
    public void initializeOrder() {
        setId(new OrderId(newUUID()));
        trackingId = new TrackingId(newUUID());
